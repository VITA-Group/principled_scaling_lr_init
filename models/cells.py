...
class InferCell(nn.Module):
    ...
    def __init__(self, genotype, C_in, C_out, stride, degrees=None):
        ...
        for i in range(1, len(genotype)):
            ...
            for (op_name, op_in) in node_info:
                ...
                _init(layer, degree=degrees[0][op_in] if degrees else 1, mode=MODE) # by in-degree
                # _init(layer, degree=degrees[1][op_in] if degrees else 1, mode=MODE) # by out-degree
